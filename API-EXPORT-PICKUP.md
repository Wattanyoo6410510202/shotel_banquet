...
[
  {
    ...
    "extra_items": [
      { "menu_item_id": 200, "name": "Soft Drink", "unit": "โต๊ะ", "per_person": false, "qty": 3 }
    ],
...
| `packages` | array | แพ็กเกจที่อนุญาตให้เลือกในลิงก์นี้ (`id`/`name`) — มีค่าเสมอไม่ว่าจะ submit แล้วหรือยัง |
